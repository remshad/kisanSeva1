...
<body>
  ...
  <div id="tab-container">
    <div class="row">
      ...
      <div class="col-md-9" style="width: 65%;margin-left: 10%;">
      <ul id="tab2" class="nav nav-pills">
        ...
        <li><a href="#tab2-item8" data-toggle="tab">Crop Fertilizers</a></li>
        <li><a href="#tab2-item9" data-toggle="tab">Disease and Solutions</a></li>
      ...
      <div class="tab-content">
            ...
            <form action="index.php#tab2-item6" method="POST">
              ...
              <table class="table table-striped">
                ...
                if (isset($_POST['search'])) {
                  ...
                  echo   $sql = "SELECT c_name,dr_quantity,dr_unit_price,dr_date,de_phone  FROM dealer_request NATURAL JOIN crop NATURAL JOIN dealer join village where dealer.v_id=$sid and village.v_id=$sid ";
                  $result = mysqli_query($link, $sql);
                  $i = 0;
                  while ($row = mysqli_fetch_assoc($result)) {
                    $i++;
        ...
        <div class="tab-pane fade" id="tab2-item7">
          <form action="index.php" method="post">
            <table>
              <tr>
                <th>Crop Instructions</th>
              </tr>
              <tr>
                <td>
                  <select class="browser-default custom-select" id="catarea3">
                    <option value="" disabled selected>Category</option>
                    <?php
                    $sql = "SELECT * FROM crop_category";
                    $result = mysqli_query($link, $sql);
                ...
                <div class="form-group">
                  <select class="browser-default custom-select" id="croparea3" name="cropinstr">
                    <option value="" disabled selected>Crop Name</option>

                  </select><br>
                  <input type="submit" class="login100-form-btn" name="subcropinstr" value="Show Crop Instructions">
                  <br>
                </td>
              </tr>
              <tr>
