...
<head>
    ...
    <title>Agriofficer landing</title>
...
<div class="form-group">
		...
		<table class="table table-striped">
                ...
                <script>
				  ...
				  <div class="form-group">
                                <button type="submit" name="search" class="btn btn-success">Get</button>
                            </div>
                            <div class="form-group">
                                    ...
                                    if(isset($_POST['update1']))
                                         {
                                             $nm=$_POST['crop'];
                                             $text=$_POST['editor2'];
                                             $sql = "SELECT * FROM  crop_fertilizers, crop where crop_fertilizers.c_id=$nm AND crop_fertilizers.c_id=crop.c_id ";
                                             $result = mysqli_query($link, $sql);
                                             if (mysqli_num_rows($result) > 0)
                                             {
                                               $sql1 = "UPDATE crop_fertilizers SET cf_text='".$text."' WHERE c_id='".$nm."'";
                                               $result1 = mysqli_query($link, $sql1);
                                             }
                                             else
                                             {
                                                 $sql = "INSERT INTO crop_fertilizers(c_id,cf_text) VALUES('".$nm."','".$text."')";
								                 $result = mysqli_query($link, $sql);
                                             }
                                         }
                                ?>
                ...
                <script>
				 	  ...
				 	  <div class="form-group">
                                <button type="submit" name="search1" class="btn btn-success">Get</button>
                            </div>
                            <div class="form-group">
                                    ...
                                    if(isset($_POST['update2']))
                                         {
                                             $nm=$_POST['crop'];
                                             $text=$_POST['editor3'];
                                             $sql = "SELECT * FROM  crop_disease, crop where crop_disease.c_id=$nm AND crop_disease.c_id=crop.c_id ";
                                             $result = mysqli_query($link, $sql);
                                             if (mysqli_num_rows($result) > 0)
                                             {
                                               $sql1 = "UPDATE crop_disease SET cd_text='".$text."' WHERE c_id='".$nm."'";
                                               $result1 = mysqli_query($link, $sql1);
                                             }
                                             else
                                             {
                                                 $sql = "INSERT INTO crop_disease(c_id,cd_text) VALUES('".$nm."','".$text."')";
								                 $result = mysqli_query($link, $sql);
                                             }
                                         }
                                ?>	
                ...
                <script>
				 ...
				 <div class="form-group">
                                <button type="submit" name="search2" class="btn btn-success">Get</button>
                            </div>
                            <div class="form-group">
                                    ...
                                    if(isset($_POST['update3']))
                                         {
                                             $nm=$_POST['crop'];
                                             $text=$_POST['editor4'];
                                             $sql = "SELECT * FROM  crop_tips, crop where crop_tips.c_id=$nm AND crop_tips.c_id=crop.c_id ";
                                             $result = mysqli_query($link, $sql);
                                             if (mysqli_num_rows($result) > 0)
                                             {
                                               $sql1 = "UPDATE crop_tips SET ct_tips='".$text."' WHERE c_id='".$nm."'";
                                               $result1 = mysqli_query($link, $sql1);
                                             }
                                             else
                                             {
                                                 $sql = "INSERT INTO crop_tips(c_id,ct_tips) VALUES('".$nm."','".$text."')";
								                 $result = mysqli_query($link, $sql);
                                             }
                                         }
                                ?>	
                ...
                <script>
				  ...
				  <div class="form-group">
                                <button type="submit" name="search3" class="btn btn-success">Get</button>
                            </div>
                            <div class="form-group">
